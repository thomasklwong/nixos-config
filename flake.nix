{
  ...
  outputs = { self, darwin, nix-homebrew, homebrew-bundle, homebrew-core, homebrew-cask, /* majd-ipatool, hashicorp, */ home-manager, nixpkgs, disko, agenix, /* secrets */ ... } @inputs:
    let
      user = "thomas";
